import { CategoriesType, DiceValue, Difficulty, IBoard, IBoardItem, IScore, IscoreBoard, ItemSelectedBoard, ItemType, Player, TotalPlayers, TypeGame, valueDice } from "../../interfaces";
