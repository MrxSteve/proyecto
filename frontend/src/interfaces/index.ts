import {
  ...
  // se va renderizar en un upper o lower section
  export type ItemType = keyof typeof EItemType; 
  
  //valor que se va mostrar en la tabla
  // los unicos valores que se van a permitir son del 1 al 6
  ...
  //nos indica los diferentes tipos que podemos permitir en lower section
